  ...
  e.fn.pagination = function(a) {
    function t(t) {
      var s = e("." + r.contents + ".current").children().length,
        ...
        o =
          '<ul id="page-navi">\t<li><a href="#" class="previos">' +
          r.previous +
          "</a></li>";
      ...
      var c = t;
      0 == t
        ? (c = parseInt(e("#page-navi li a.current").html())) - 1 != 0 && c--
        : t == l + 1 &&
          (c = parseInt(e("#page-navi li a.current").html())) + 1 != l + 1 &&
          c++,
        (t = c),
        0 == s && (o = ""),
        e("#page-navi").remove(),
        ...
        e("#page-navi li a")
          .eq(t)
          .addClass("current"),
        e("#page-navi li a").removeClass("disable"),
    ...
    !(function() {
      ...
      e(document).on("click", "#page-navi li a", function() {
        return (
          !e(this).hasClass("disable") &&
          (t(e("#page-navi li a").index(this)), !1)
        );
      }),
